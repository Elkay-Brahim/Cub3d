...
SRCB = $(addprefix bonus/, cross.c _dda.c _fold_of_view.c backgrand.c check_state_door.c break_of_x.c break_of_y.c calcul_destance_x.c calcul_destance_y.c mouse_hook.c color.c dda_draw.c \
